...
texts= ['a love b', 'a love c', 'a love d', 'a love e', 'a love f', 'a love g', 'a love h', 'a love i', 'a love j', 'a love k', 'a love l']
def random_info():
    user_id = str(random.randint(100, 999)) + '-' + str(random.randint(1000, 9999)) + '-' + str(random.randint(1000, 9999))
